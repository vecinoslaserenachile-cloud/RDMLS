...
// Listas de reproducciA³n diferenciadas por pilares
const PLAYLIST_INSTITUTIONAL = [
    ...
    { url: 'https://cdn.jsdelivr.net/gh/vecinoslaserenachile-cloud/juego-serenito@main/Serenito_Polideportivo_Las_Compañías.mp4', title: 'Polideportivo Las Compañías' },
...
export default function HubDashboard() {
    ...
    // â”€â”€ MASTER EDITOR MODE (solo vecinoslaserenachile@gmail.com) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ GESTION DE HANDLERS GLOBALES (Component Scope) â”€â”€
    ...
    const handleShareNews = (news) => {
        ...
        if (navigator.share) {
            ...
            alert('Â¡Enlace de noticia copiado al portapapeles!');
        }
    };
    ...
    const dict = {
        es: {
            ...
            newsAlert: isRDMLS 
                ? "INFORMATIVO VLS: La Red Digital La Serena informa despliegue de equipos en terreno para mantención urbana. Siga la señal de RDMLS para más detalles."
            ...
            heroDescription: isRDMLS
                ? 'Plataforma oficial de inducción, gestión y capacitación continua para colaboradores de La Serena en diversas modalidades.'
        ...
        zh: {
            ...
            listeningTitle: "智慧观众 (Smart Listening)", listeningSub: "哨兵灯塔和社交监听网络 (Centinel Faro)",
            paseo3dTitle: "3D 历史走廊", paseo3dSub: "传统建筑和博物馆",
            busdeltiempoTitle: "时光大巴", busdeltiempoSub: "从 1948 年到智慧城市的旅行",
        ...
        arn: {
            ...
            welcomePortales: "Kúme akun portal unificado Vecinos La Serena mu. Inatunge kom pu kúzaw ciudadanas fan."
        },
        ht: {
            title: "Hub de Comunicaciones y Ciudadanía Smart - Portal Unificado VLS",
            saludTitle: "Smart Salud", memorialTitle: "Altares de la Región",
    ...
    const greetingsRDMLS = [
        { text: "PORTAL RDMLS.cl", sub: "RDMLS SOBERAN�A DIGITAL", color: "#f59e0b", bg: "linear-gradient(135deg, #1e1b4b 0%, #312e81 100%)", flag: "🏛️" },
    ...
    const newsFlashes = [
        {
            es: "Bienvenido al Portal Institucional Vecinos La Serena: Su conexión directa con los servicios institucionales y la innovación ciudadana.",
    ...
    useEffect(() => {
        const handleNews = () => {
            ...
            let newsList = [];
            const defaultNews = [
                { title: "SMART CITIZENS: Reporte Urbano Georreferenciado", date: "Hoy", category: "CIUDADANÍA", desc: "Monitoreo en tiempo real de baches y luminarias mediante IA para una respuesta institucional inmediata.", iconStr: "Search", color: "#10b981", eventId: "open-vls-reporte", image: "/vls_seguridad_central.png" },
                { title: "SMART ADMINISTRATION: Portal E-Learning Institucional", date: "Hoy", category: "GESTIÓN", desc: "Nueva plataforma de inducción con firma digital y entrega de certificados para funcionarios.", iconStr: "GraduationCap", color: "#3b82f6", eventId: "open-vls-academia", image: "/serenito_3d_avatar_premium_1774312066289.png" },
                { title: "SMART EVENTS: Monitor de Precedencias 2025", date: "Hoy", category: "PROTOCOLO", desc: "Gestión automatizada de eventos y seguimiento de autoridades regionales en tiempo real.", iconStr: "Users", color: "#8b5cf6", eventId: "open-vls-protocolo", image: "/serenito_security_guard_close_up_1773392164475.png" },
                { title: "SMART LISTENING: Inteligencia Centinel Faro", date: "Hoy", category: "SEGURIDAD", desc: "Escucha activa y análisis de video mediante IA para la prevención de incidentes críticos.", iconStr: "Eye", color: "#f59e0b", eventId: "open-faro-ia", image: "/faro_monumental_premium_png_1774894700995.png" },
                { title: "RADIO VLS: Sintonía Digital 24/7", date: "Hoy", category: "RADIO", desc: "La voz de los barrios y la cultura serenense en alta fidelidad por RDMLS.cl.", iconStr: "Mic", color: "#ef4444", eventId: "open-radio-vls", image: "/rdmls_pwa_icon.png" },
            ];
    ...
    const servicios = [
        ...
        {
            id: 'serenito-admin', title: 'Serena Met (Admin)', subtitle: 'Inyectora de Locución y Reporte Móvil Terreno',
        ...
        {
            id: 'vls-tv-ip', title: 'TV IP VLS', subtitle: 'Señales Nacionales e Internacionales en Alta Definición',
        ...
        {
            id: 'smart-architecture', title: 'Arquitectura & Obras', subtitle: 'Diseño, Ampliaciones y Permisos de Edificación',
            icon: Ruler, color: '#3b82f6', path: '/arquitectura', active: true, badge: 'DOM'
        },
        {
            id: 'smart-learning', title: isRDMLS ? 'Inducción La Serena' : 'Smart Academia VLS', subtitle: isRDMLS ? 'Pilar #2: Capacitación, Diplomas y Soberanía' : 'Capacitación, Inglés, Diplomas y Saberes Locales',
        ...
        // Si es VLS, filtramos lo que explícitamente diga institucional/institucional si se desea ocultar, 
    ...
    const participacionCiudadana = [
        ...
        {
            id: 'ecumenico', title: 'Portal Ecumédico y Espiritual', subtitle: 'Encuentro Interreligioso de Fe (Iglesias, Cultos y Templos)',
    ...
    const allApps = [...servicios, ...participacionCiudadana, ...internalTools]
        ...
        .map(app => {
            ...
            if (isRDMLS) {
                ...
                if (app?.id === 'smart-learning') return { ...app, title: 'Inducción La Serena', badge: 'VLS' };
            }
            return app;
        })
        .filter(app => app !== null);
    ...
    const baseCategories = [
        ...
        },
        {
            ...
            description: isRDMLS
                ? 'Portal de inducción E-learning (entrega de diplomas) y digitalización de informes para trabajadores institucionales (Honorarios) con firma digital.'
    ...
    const [impactMessages, setImpactMessages] = useState([
        { icon: Award, color: '#fbbf24', text: isRDMLS ? "[RDMLSabes]: Juega la trivia oficial y valida tus conocimientos regionales." : "[VLSABES]: ¿Cuánto sabes de tu comuna? Juega la trivia oficial y gana fichas para el portal." },
        { icon: Map, color: '#38bdf8', text: "[El Túnel de Tiempo]: Viaja al pasado de La Serena en 3D. Explora el centro histórico como era hace 100 años." },
        { icon: Box, color: '#c084fc', text: "[Render 3D]: Ya puedes visualizar tu indumentaria institucional en 3D antes de pedirla." },
        { icon: AlertCircle, color: '#ef4444', text: isRDMLS ? "[Gestión La Serena]: Reporte de baches y luminarias integrado con la central de mando." : "[Smart Comuna]: Reporta baches, luminarias o basura con un solo click. Gestión directa con la administración." },
        { icon: Radio, color: '#38bdf8', text: isRDMLS ? "[RDMLS]: La radio oficial de La Serena ya está en el aire. Escucha la programación regional 24/7." : "[Radio VLS]: La voz de los vecinos ya está en el aire. Escucha música y noticias locales 24/7." },
    ...
    const guardianes = [
        { id: 'serenito-guard', name: 'Serenito', role: 'Seguridad & Protección', model: '/models/serenito_38.glb', img: '/serenito_3d_humanized_2025_1774875415876.png', bio: isRDMLS ? 'Experto en seguridad urbana y IA biométrica. El corazón del Portal RDMLS.' : 'Experto en seguridad vecinal y IA biométrica. El corazón de VecinoSmart.' },
    ...
    if (isRDMLS) {
        return (
            <div className="page-container trencadis-guell" style={{ 
                ...
                <SeoHead 
                    title="RDMLS.cl — Red Digital Movilizando La Serena"
                ...
                >
                    ...
                    <p style={{ color: '#94a3b8', fontSize: '1.2rem', lineHeight: 1.6, maxWidth: '600px', margin: '0 auto 2rem' }}>
                        Informamos a la comunidad que la señal de radio y el portal institucional de RDMLS se encuentran en un proceso de <strong>reestructuración técnica y administrativa</strong>. 
                    </p>
                ...
                <footer style={{ marginTop: '4rem', opacity: 0.5, fontSize: '0.8rem' }}>
                    © 2025 RDMLS SOBERAN�A DIGITAL · DEPARTAMENTO DE COMUNICACIONES
                </footer>
            </div>
        );
    }
                                ...
                                <div style={{ textAlign: isMobile ? 'center' : 'left', maxWidth: '600px', display: 'flex', flexDirection: 'column', gap: '0.8rem', alignItems: isMobile ? 'center' : 'flex-start' }}>
                                    ...
                                    <div style={{ minHeight: '110px' }}>
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '1rem', justifyContent: isMobile ? 'center' : 'flex-start' }}>
                                            ...
                                            {/* CAJA DE TRADUCCIÓN INTELIGENTE RESTAURADA */}
                                            <motion.div 
                                            ...
                                            >
                                                ...
                                                <span style={{ color: 'white', fontSize: '0.85rem', fontWeight: 'bold' }}>
                                                    {greetingIdx === 0 ? 'Portal Ciudadano Inteligente' : `Traducción: "${greetings[0].text.replace('¡', '').replace('!', '')}"`}
                                                </span>
                                            </motion.div>
                                        </div>
                                    </div>
            ...
            <div style={{
                ...
                >
                    ...
                    <div style={{ flex: 1, zIndex: 1 }}>
                        ...
                        <p style={{ color: 'rgba(125, 211, 252, 0.9)', fontSize: '0.85rem', margin: '4px 0 0 0', fontWeight: '500' }}>Atención Ciudadana & Reportes</p>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style={{ flex: 1, zIndex: 1 }}>
                        ...
                        <p style={{ color: 'rgba(187, 247, 208, 0.9)', fontSize: '0.85rem', margin: '4px 0 0 0', fontWeight: '500' }}>Gestión Interna & E-learning</p>
                    </div>
                </div>
                        ...
                        >
                            ...
                            <div style={{ position: 'relative', padding: '5rem', zIndex: 10, maxWidth: '1000px' }}>
                                ...
                                <h2 style={{ color: 'white', fontSize: 'clamp(2.5rem, 8vw, 5.5rem)', fontWeight: 950, margin: 0, letterSpacing: '-3px', lineHeight: 0.85 }}>
                                    AKICHIP:<br/>
                                    <span style={{ color: '#ef4444' }}>EL CORAZON TECNOLÓGICO</span>
                                </h2>
                ...
                <div style={{ padding: '2rem 1.5rem 0', maxWidth: '1400px', margin: '0 auto', width: '100%', boxSizing: 'border-box' }}>
                    ...
                    {/* NUEVA SECCION CAMARAS EN VIVO C5 */}
                    <div className="vls-perf-section" style={{ maxWidth: '1200px', margin: '3rem auto 0 auto', width: '100%' }}>
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '1.5rem', gap: '1rem' }}>
                            ...
                            <h3 style={{ color: '#10b981', margin: 0, fontSize: '1.3rem', letterSpacing: '2px', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: '0.8rem' }}>
                                ...
                                Cámaras C5 en Vivo (Faro & Radio La Serena)
                            </h3>
                            <div style={{ height: '1px', flex: 1, background: 'linear-gradient(-90deg, transparent, rgba(16,185,129,0.5))' }}></div>
                        </div>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                    ...
                                    <div style={{ flex: 1, borderRadius: '15px', overflow: 'hidden', border: '1px solid rgba(255,255,255,0.1)', background: '#000', boxShadow: '0 20px 40px rgba(0,0,0,0.4)', position: 'relative' }}>
                                        <div style={{ background: '#1a1a1a', padding: '8px 15px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                                            ...
                                            <span style={{ fontSize: '0.65rem', color: '#888', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px' }}>Centro Histórico</span>
                                        </div>
                                        <div style={{ position: 'relative', height: 'calc(100% - 31px)' }}>
                                            {(!isMobile) ? (
                                            <video
