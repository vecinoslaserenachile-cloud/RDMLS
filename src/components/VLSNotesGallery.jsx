...
const LEGACY_NOTES = [
    ...
    { 
        ...
        body: "Campos deconstruye su instrumento convirtiéndolo en una orquesta solista, explorando desde el folklore imaginario hasta el jazz fusión más agresivo. Durante la sesión, explica cómo el bajo puede ser melódico, percusivo y armónico al mismo tiempo, rompiendo los moldes tradicionales de la rítmica. Su enfoque pedagógico y su destreza técnica son un regalo para cualquier aspirante a músico.",
        contacto: "Web: jorgecampos.cl", cita: "El bajo es el corazón que conecta la tierra con el cielo.",
        color: "#3b82f6",
        tacticalIcons: [
            { icon: LayoutGrid, label: 'Arquitectura Jazz', color: '#3b82f6', desc: 'Fusión Elite' },
            { icon: Heart, label: 'Pulso Vital', color: '#ec4899', desc: 'Corazón del Ritmo' },
            { icon: ShieldCheck, label: 'Maestro VLS', color: '#ffffff', desc: 'Excelencia Técnica' }
        ]
    },
    { 
        ...
        body: "Solange Miranda lidera el movimiento 'Adobe Vivo' en la Región de Coquimbo, rescatando la arquitectura de tierra no como una curiosidad histórica, sino como una respuesta tecnológica a la crisis climática. Durante la entrevista, Solange explica que el adobe posee una inercia térmica natural que mantiene los hogares frescos en verano y cálidos en invierno sin consumo energético redundante. El desafío actual reside en la normativa: Solange trabaja en protocolos de refuerzo sísmico mediante geomallas y tensores de madera que permiten que el adobe cumpla con los estándares de seguridad modernos. Su visión es clara: 'Debemos construir con el suelo que pisamos para sanar el tejido urbano y nuestra relación con el territorio'. Este especial detalla los proyectos piloto en el Valle del Elqui donde casas de barro han resistido sismos de alta magnitud, demostrando su resiliencia estructural.",
        contacto: "@mastierra_arquitectura", cita: "El adobe nos permite respirar con el entorno.",
        color: "#8b5cf6",
        tacticalIcons: [
            { icon: Home, label: 'Estructura Adobe', color: '#92400e', desc: 'Resiliencia Sísmica' },
            { icon: Thermometer, label: 'Inercia Térmica', color: '#d97706', desc: 'Soberanía Energética' },
            { icon: Sparkles, label: 'Bio-Construcción', color: '#b45309', desc: 'Patrimonio Vivo' }
        ]
    },
    { 
        ...
        body: "En la desembocadura del Río Elqui, un ecosistema vital lucha por su supervivencia frente a la presión urbana. Javiera Campos, activista y guardiana del humedal, relata la situación crítica de la biodiversidad local, poniendo especial énfasis en el Pilpilén (Haematopus palliatus), un ave costera que anida directamente en la arena. La entrada de jeeps y camiones no solo destruye los nidos, sino que altera el ciclo reproductivo de especies migratorias. Durante la entrevista, Javiera detalla la implementación de barreras naturales y la necesidad urgente de una ordenanza municipal que regule el acceso vehicular. 'El humedal es la esponja de la ciudad; sin él, somos vulnerables a marejadas e inundaciones', advierte Javiera, quien lidera patrullares ciudadanos para denunciar rellenos ilegales y la caza furtiva en esta zona de protección prioritaria.",
        contacto: "Depto. Medio Ambiente LS", cita: "Si el humedal muere, la ciudad queda desprotegida.",
        color: "#14b8a6",
        tacticalIcons: [
            { icon: Bird, label: 'Nidificación Pilpilén', color: '#0369a1', desc: 'Defensa Especie' },
            { icon: Waves, label: 'Filtro Elqui', color: '#0ea5e9', desc: 'Ecosistema Hídrico' },
            { icon: ShieldCheck, label: 'Zonificación', color: '#0284c7', desc: 'Misión Humedal' }
        ]
    },
    { 
        ...
        body: "El Culebrón ha sido históricamente el patio trasero de Coquimbo. Paulina Godoy propone dar vuelta la ciudad para mirar de frente a su humedal. Su Plan Maestro es una hoja de ruta hacia la sostenibilidad urbana. En lugar de muros de contención de hormigón, Godoy diseña parques inundables y bordes blandos que absorben la energía de las marejadas, protegiendo la ciudad de forma inteligente. El proyecto contempla muelles de avistamiento, senderos elevados para no compactar el suelo y la reforestación con especies xerófitas. Paulina destaca que 'el humedal no es un pantano sucio, es una infraestructura verde de primer nivel que hoy es ignorada por el mercado inmobiliario'. Su visión busca reconciliar al habitante de Coquimbo con su patrimonio natural más preciado, creando un pulmón verde donde antes solo había microbasurales.",
        contacto: "Instagram: @paulinagodoy.arq", cita: "El Culebrón es el pulmón que Coquimbo necesita para respirar futuro.",
        color: "#ec4899",
        tacticalIcons: [
            { icon: Building2, label: 'Urbanismo Vivo', color: '#ec4899', desc: 'Plan Maestro' },
            { icon: Landmark, label: 'Patrimonio de Agua', color: '#8b5cf6', desc: 'Diseño Inclusivo' },
            { icon: Sprout, label: 'Recuperación', color: '#22c55e', desc: 'Fin de Basurales' }
        ]
    },
    { 
    ...
    { 
        ...
        body: "Para Daniela Olmos, la pobreza energética es un problema de diseño. Su propuesta arquitectónica busca dignificar la vivienda social utilizando lana de oveja local como aislante térmico superior. A diferencia de los materiales sintéticos habituales, la lana es ignífuga, biodegradable y gestiona la humedad del hogar de forma pasiva. Daniela detalla sus proyectos en zonas rurales donde el frío cordillerano es extremo: 'Hemos logrado reducir el gasto en calefacción en un 60%, devolviendo confort y salud a las familias'. Su trabajo es una crítica frontal a las soluciones estandarizadas de construcción estatal que ignoran las particularidades climáticas de nuestra región.",
        contacto: "@danielaolmos.arq", cita: "La arquitectura bioclimática es una herramienta de justicia social.",
        color: "#10b981",
        tacticalIcons: [
            { icon: Beef, label: 'Aislamiento Natural', color: '#10b981', desc: 'Lana de Oveja' },
            { icon: Home, label: 'Vivienda Social 2.0', color: '#059669', desc: 'Dignidad Térmica' },
            { icon: Sprout, label: 'Bio-Materiales', color: '#22c55e', desc: 'Residuo Cero' }
        ]
    },
    { 
    ...
    { 
        ...
        body: "Un registro histórico invaluable de 1990. Hermógenes Hermosilla y Quintalicio Quintanilla representan la burocracia de una oficina de archivos y partes bajo el mando de la señorita Astrid. Esta sátira, emitida originalmente en Canal 13, hoy sirve como espejo de la administración pública que el Pilar #2 de VLS (Smart Administration) busca modernizar definitivamente. Sus sketches sobre timbres, colaciones interminables y el 'no hay sistema' son clásicos de la cultura pop chilena.",
        contacto: "Archivo REC TV / Memoria VLS", cita: "El trámite es mañana, caballero.",
        color: "#f43f5e",
        tacticalIcons: [
            { icon: Clock, label: 'El Timbre Eterno', color: '#f43f5e', desc: 'Burocracia 1.0' },
            { icon: Box, label: 'Archivos Muertos', color: '#94a3b8', desc: 'Papelería Retro' },
            { icon: Scale, label: 'Justicia Administrativa', color: '#fbbf24', desc: 'Humor Crítico' }
        ]
    }
];
              ...
              >
                ...
                <div style={{ padding: isMobile ? '1.5rem' : '4rem', paddingBottom: '6rem' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: !isMobile ? '2fr 1fr' : '1fr', gap: '4rem' }}>
                    <div style={{ fontSize: isMobile ? '1.1rem' : '1.3rem', lineHeight: '1.8', color: '#1e293b' }}>
                      ...
                      <div style={{ marginTop: '3rem', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
                        <div style={{ background: '#f1f5f9', padding: '1rem 1.5rem', borderRadius: '20px', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.9rem', fontWeight: 'bold', color: '#475569' }}>
                          <Video size={20} /> Entrevista Master (VLS TV)
                        </div>
                        <div style={{ background: '#f1f5f9', padding: '1rem 1.5rem', borderRadius: '20px', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '0.9rem', fontWeight: 'bold', color: '#475569' }}>
                          <Mic size={20} /> Registro Sonoro RDMLS
                        </div>
                      </div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem' }}>
                      <div style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%)', padding: '2.5rem', borderRadius: '35px', border: `1px solid ${selectedNote.color}30`, textAlign: 'center' }}>
                        ...
                        <p style={{ color: selectedNote.color, fontWeight: 'bold', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '3px', marginTop: '10px' }}>Invitada Estelar</p>
                      </div>
