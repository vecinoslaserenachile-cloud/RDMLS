                  ...
                  <AnimatePresence mode="wait">
                    {questionImage ? (
                      ...
                      <div className="absolute inset-0 flex items-center justify-center opacity-20">
                        <RefreshCw className="w-20 h-20 animate-spin text-game-gold" />
                      </div>
                    ) : null}
                  </AnimatePresence>

                  <div className="relative z-10 max-w-4xl">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.8)] mb-4">
