...
const startIndex = 3875; // Start of Premium Card
const endIndex = lines.findIndex((l, i) => i > 4000 && l.includes('NUEVA SECCI'));
...
if (startIndex !== -1 && endIndex !== -1) {
    ...
    console.log('Successfully repaired HubDashboard.jsx (Emergency Clean V3)');
} else {
